...
},{}],"src/pluginVM.tsx":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function PluginVM() {
    ...
    _this.makeChanges = function () {
      ...
      for (var i = textNodes.length - 1; i >= 0; i--) {
        ...
        _this.setFontSize(element.parentNode);

        _this.setFontFamily(element.parentNode);

        if (element.tagName === 'A') _this.setHighlightsInLinks(element.parentNode);
        if (element.tagName == "IMG" && !element.getAttribute('alt')) _this.setHighlightsInImages(element);
      }
    };
  ...
  PluginVM.prototype.render = function () {
    var _this = this;
  ...
  PluginVM.prototype.setFontSize = function (element) {
    element.style.setProperty('font-size', parseFloat(getComputedStyle(element).fontSize) * 1.2 + 'px');
  };

  PluginVM.prototype.setFontFamily = function (element) {
    element.style.setProperty('font-family', 'Arial');
  };

  PluginVM.prototype.setHighlightsInLinks = function (element) {
  ...
  PluginVM.prototype.setHighlightsInImages = function (element) {
...
var pluginVM_1 = __importDefault(require("./pluginVM"));

preact_1.render(preact_1.h(pluginVM_1.default, null), document.body);
},{"preact":"node_modules/preact/dist/preact.mjs","./pluginVM":"src/pluginVM.tsx"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
